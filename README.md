...
창업가의 1시간 안팎 영어 YouTube 인터뷰 링크를 넣으면 영상과 영어 원문 자막을 로컬에 저장하고, 창업가가 공감하거나 재미있어할 약 1분 클립 후보(60초 선택 시 최대 65초)를 만드는 개인용 macOS 앱입니다. 구간 선택은 영어 원문을 기준으로 하며, 각 후보는 영어 원음이 유지된 9:16 영상, 자연스러운 한국어 자막, 상단의 주황색 한국어 후킹 제목으로 렌더링됩니다.
